            ...
            <div className="flex items-center gap-3 ml-auto">
              <div className="flex items-center gap-1.5 mr-1">
                <a
                  ...
                  className="w-7 h-7 rounded-full border border-green-900/20 flex items-center justify-center text-green-900 hover:bg-green-600 hover:border-green-600 hover:text-white transition-colors"
                  aria-label="Facebook"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-7 h-7 rounded-full border border-green-900/20 flex items-center justify-center text-green-900 hover:bg-gradient-to-br hover:from-purple-500 hover:to-pink-500 hover:border-transparent hover:text-white transition-all"
          ...
          <nav className="flex flex-col px-4 py-3 gap-1">
            ...
            <div className="flex items-center gap-3 px-4 py-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-full border border-green-900/20 flex items-center justify-center text-green-900 hover:bg-green-600 hover:border-green-600 hover:text-white transition-colors"
                aria-label="Facebook"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-full border border-green-900/20 flex items-center justify-center text-green-900 hover:bg-gradient-to-br hover:from-purple-500 hover:to-pink-500 hover:border-transparent hover:text-white transition-all"
                aria-label="Instagram"
              >
